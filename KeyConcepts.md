...
See [this image](https://raw.githubusercontent.com/wiki/shawnlaffan/biodiverse/screenshots/cluster_analysis_results_page_recalc_linkage.png) for an example.

If the negative nodes make interpretation difficult then change the display [to plot by depth](https://raw.githubusercontent.com/wiki/shawnlaffan/biodiverse/screenshots/cluster_analysis_results_page_recalc_linkage_plot_by_depth.png).
